...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="form-floating mt-4">
        <input type="hidden" class="form-control" id="floatingInput" placeholder="Id Anggota" name="id_anggota" value="<?=$row['id_anggota']?>">
        <label for="floatingInput">Id Anggota</label>
     </div>

    <div class="form-floating mt-4">
       <input type="text" class="form-control" id="floatingInput" placeholder="Nama Anggota" name="nama_anggota" value="<?=$row['nama_anggota']?>" required>
        <label for="floatingInput">Nama Anggota</label>
     </div>

     <div class="form-floating mt-4">
       <input type="text" class="form-control" id="floatingInput" placeholder="Alamat Anggota" name="alamat_anggota" value="<?=$row['alamat_anggota']?>" required>
        <label for="floatingInput">Alamat Anggota</label>
     </div>
     ...
     <div class="form-floating mt-4">
        <input type="text" class="form-control" id="floatingPassword" placeholder="No Telp" name="no_telp" value="<?=$row['no_telp']?>" required>
        <label for="floatingPassword">No Telp</label>
      </div>
