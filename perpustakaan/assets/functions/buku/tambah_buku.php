  ...
  <div class="row">
    ...
    <form action="proses_tambah_buku.php" method="POST">
     <div class="form-floating mt-4">
       <input type="text" class="form-control" id="floatingInput" placeholder="Nama Buku" name="nama_buku" required>
        <label for="floatingInput">Nama Buku</label>
     </div>
        
     <div class="form-floating mt-4">
        <input type="text" class="form-control" id="floatingPassword" placeholder="Jenis Buku" name="jenis_buku" required>
        <label for="floatingPassword">Jenis Buku</label>
      </div>

      <div class="form-floating mt-4">
       <input type="number" class="form-control" id="floatingInput" placeholder="Tahun Terbit" name="tahun_terbit" required>
